 ...
 *                      That is a nice practice we can use for the page object class. This class is similar to previeus one ('03.FillTheForm.po'). The main difference is in the 'spec' class.
